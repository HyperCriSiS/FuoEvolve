...
/**
 * Temporary P4 compatibility factory for shared concrete providers that still produce display
 * strings. The string is classified at the application boundary and is not stored in the
 * provider-neutral result contract. Concrete providers should emit ProviderFailure directly in P5.
 */
...
/** See [ProviderSearchResults] compatibility factory above. */
@Suppress("FunctionName", "UNUSED_PARAMETER")
