...
/**
 * Application aggregate retained while callers finish migrating to narrow provider capabilities.
 * Provider-neutral capability contracts live in :provider:api; only playback policy coupling remains
