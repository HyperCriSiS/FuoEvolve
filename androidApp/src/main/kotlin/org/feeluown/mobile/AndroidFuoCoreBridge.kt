...
class AndroidFuoCoreBridge(
    ...
    private fun JSONObject.toPayload(track: MusicTrack): PlaybackPayload {
        ...
        return PlaybackPayload(
            ...
            originalId = optString("original_id").takeIf { smartReplacement && it.isNotBlank() },
            originalTitle = optString("original_title").takeIf { smartReplacement && it.isNotBlank() },
            originalArtists = optString("original_artists").takeIf { smartReplacement && it.isNotBlank() },
            originalAlbum = optString("original_album").takeIf { smartReplacement && it.isNotBlank() },
            originalSource = optString("original_source").takeIf { smartReplacement && it.isNotBlank() },
            ...
            replacementId = optString("replacement_id").takeIf { smartReplacement && it.isNotBlank() },
            ...
            replacementAlbum = optString("replacement_album").takeIf { smartReplacement && it.isNotBlank() },
